...
void Table::sparseMatrixPrint()
{
    logger.log("Table::sparseMatrixPrint");

    // this->sort(); - First sort to get the r values in order first and then c values
