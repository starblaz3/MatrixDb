...
bool syntacticParse()
{
    ...
    else if(possibleQueryType == "TRANSPOSE_SPARSE_MATRIX")
        return syntacticParseTRANSPOSE_SPARSE_MATRIX();
    else
    {
...
void ParsedQuery::clear()
{
    ...
    this->crossTransposeRelationNameA = "";
    this->crossTransposeRelationNameB = "";

    this->sourceFileName = "";

    this->listEntityType = "";   

    this->transposeSparseMatrixName = "";  
}
